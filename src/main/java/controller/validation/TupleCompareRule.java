...
public class TupleCompareRule implements IValidate{
    public boolean Validate(Map<String, String> Brule){
        ...
        String[] fieldstrigger = "TARGET_TABLE|TARGET_COLUMN|GRULETYPE_RULETYPE_ID|TRIGGER_EVENT|TRIGGER_ON|OPERATOR|COMPARE_COLUMN".split("\\|");
        String[] fieldscontraint = "TARGET_TABLE|TARGET_COLUMN|GRULETYPE_RULETYPE_ID|OPERATOR|COMPARE_COLUMN".split("\\|");
